"""
The model module contains items which serve as the model layer of
the calculator application. Namely, the Calculator holds the operands
and operators and can calculate the resulting new value.
"""
...
class Operand:
    ...
    def invert_sign(self) -> bool:
        ...
        A sign is not changed in case the operand is empty (i.e. no digits).
