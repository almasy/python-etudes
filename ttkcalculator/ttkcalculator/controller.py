"""
The controller module contains a controller responsible interpreting
'events' from the view (calculator keypad), instructing the model
(calculator engine) and passing the results from the model back
to the view (calculator display).
"""
...
__all__ = ['KeypadController', 'Error']
